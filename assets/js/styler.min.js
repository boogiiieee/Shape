...
(function ($) {
    ...
    function sync() {
        ...
        $('.styler_style').html(x);
        if (sticky_header_val == 'sticky' || sticky_header_val == 'static') {
            header.find('.header_top').slideDown();
        }
        else {
            header.find('.header_top').slideUp();
        }
        ...
        if (layout_mode == "wide") {
            layout_mode_dep.slideUp();
            $('.main_wrap').removeClass('boxed wide_box');
        }
        else if (layout_mode == "boxed") {
            layout_mode_dep.slideDown();
            $('.main_wrap').addClass('boxed');
            $('.main_wrap').removeClass('wide_box');
        }
        else {
            layout_mode_dep.slideDown();
            $('.main_wrap').addClass('wide_box');
            $('.main_wrap').removeClass('boxed');
        }
